...
1. How would you describe acessibility on the web to someone new to programming?
 Accessibility means that web sites are designed and developed so that people with disabilities can use them. (screen readers, etc)

2. Talk about 3 different things you can do to ensure your website is accessible. 

alt tags , 
semantic html, 
use color carefully ie not white on white etc. 

3. How would you explain the concept of a variable to someone new to programming?

A variable is a container that has a unique name that can store data or anything that you want really.

4. What is the purpose of using functions in code?

A function is like a procedure you can write in your code to do something. It can build things,return data, really the abilities are almost limitless. 
